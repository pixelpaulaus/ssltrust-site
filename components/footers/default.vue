<template>
    <footer class="bg-white" aria-labelledby="footer-heading">
      ...
      <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div class="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 class="text-sm font-semibold leading-6 text-gray-900">Online Tools</h3>
        ...
        <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p class="text-xs leading-5 text-gray-500">&copy; Keyko Pty Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </template>
  ...
  const navigation = {
    tools: [
      { name: 'Website Safety Check', href: '#' },
      { name: 'CSR Generator', href: '#' },
      { name: 'Installation Check', href: '#' },
    ],
    support: [
      { name: 'Help Center', href: '#' },
      { name: 'Installation Service', href: '#' },
      { name: 'Guides', href: '#' },
    ],
    company: [
      { name: 'About', href: '#' },

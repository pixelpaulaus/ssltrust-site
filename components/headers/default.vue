  ...
  <header>
    <div class="bg-gray-900 text-white">
      <div class="flex h-10 items-center justify-between px-4 sm:px-6 lg:px-8 text-white">
        ...
        <span class="h-6 w-px bg-gray-600 mx-5" aria-hidden="true" />
        ...
        <form class="hidden sm:block lg:inline-flex">
          <div class="flex">
            ...
            <div class="group relative -ml-2 rounded-md border-transparent bg-gray-900 focus-within:ring-2 focus-within:ring-white">
              <select id="desktop-currency" name="currency" class="flex items-center rounded-md border-transparent bg-gray-900 bg-none py-0.5 pl-2 pr-5 text-sm font-medium focus:border-transparent focus:outline-none focus:ring-0 group-hover:text-gray-100">
      ...
      <div class="flex items-center justify-between p-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <NuxtLink to="/">
            ...
            <img class="h-12 w-auto sm:h-16 blog md:hidden lg:block pt-2 xl:ml-12" src="/img/ssltrust-logo.svg" alt="SSLTrust" />
            <img class="h-12 w-auto sm:h-14 hidden md:block lg:hidden" src="/img/ssltrust-icon.svg" alt="SSLTrust" />
          </NuxtLink>
        </div>
        ...
        <PopoverGroup as="nav" class="hidden md:space-x-6 lg:space-x-10 md:flex">
          <Popover class="relative" v-slot="{ open, close }">
            ...
            >
              <span class="hidden lg:block">Certificates</span>
              <span class="lg:hidden">Certs</span>
              <ChevronDownIcon :class="[open ? 'text-gray-600' : 'text-gray-400', 'ml-2 h-5 w-5 group-hover:text-gray-500']" aria-hidden="true" />
            </PopoverButton>

            <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
              <PopoverPanel class="absolute z-10 -ml-4 mt-3 w-screen max-w-ls transform lg:left-1/2 lg:ml-0 lg:max-w-3xl lg:-translate-x-1/2"
              @mouseover.prevent="popoverHover = true"
              @mouseleave.prevent="closePopover(close)"
              >
                <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                  <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                    <NuxtLink v-for="solution in solutions" :key="solution.name" :to="solution.href" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                      <div class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-blue-500 text-white sm:h-12 sm:w-12">
                  ...
                  <div class="bg-gray-50 p-5 sm:p-8">
                    <a href="#" class="-m-3 flow-root rounded-md p-3 hover:bg-gray-100">
                      <div class="flex items-center">
                        <div class="text-base font-medium text-gray-900">Not sure which one you need?</div>
                      </div>
          ...
          <Popover class="relative" v-slot="{ open, close }">
            ...
            <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
              <PopoverPanel class="absolute z-10 -ml-4 mt-3 w-screen max-w-xs transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2"
              @mouseover.prevent="popoverHover = true"
              @mouseleave.prevent="closePopover(close)"
              >
                <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
          ...
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Enterprise</a>
          ...
          <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div class="px-5 pt-5 pb-6">
              <div class="flex items-center justify-between">
                <div>
                  <img class="h-8 w-auto" src="/img/ssltrust-logo.svg" alt="SSLTrust" />
                </div>
                <div class="-mr-2">
                  <PopoverButton class="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500">
